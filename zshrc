...
plugins=(gitfast brew ssh-agent rbenv last-working-dir common-aliases sublime zsh-syntax-highlighting)
...
export PATH="${HOME}/.rbenv/bin:${HOME}/anaconda3/bin:${PATH}"
